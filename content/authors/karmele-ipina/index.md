...
# Role/position
role: Professor in the Department of Systems Engineering and Automatics
...
bio: My research interests include machine Pattern Recognition, Intelligent Control, Ambient Intelligence, Speech Processing or Artificial Vision.
...
education:
  courses:
    - course: PhD in Computer Science
      ...
      year: 2003
    - course: Master Electronics and Automation
      institution: University of the Basque Country
      year: 1991
    - course: Licensed Physics Science
      institution: University of the Basque Country
      year: 1990
...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:karmele.ipina@ehu.eus'
  - icon: google-scholar
    icon_pack: ai
    link: https://scholar.google.es/citations?user=fkFBpjUAAAAJ&hl=es
  - icon: github
    icon_pack: fab
